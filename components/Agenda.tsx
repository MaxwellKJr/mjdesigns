...
const Agenda = () => {
  return (
    <section className="flex flex-col justify-center items-center w-full m-auto py-16 bg-white">
      <div className="flex flex-col lg:grid md:grid-cols-2 w-full sm:w-4/5 lg:w-3/4 mx-auto max-w-xxl p-4">
        {/* Agenda */}
        <div className="">
          <h2 className="text-2xl md:text-3xl lg:text-4xl text-primary font-bold mb-4">
            Our Goal
          </h2>
